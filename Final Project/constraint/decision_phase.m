...
function [monkey_positions, LLCnt] = decision_phase(monkey_positions, fitness, local_leaders, global_leader, LLCnt, LLL, p_b, lb, ub, groups, num_groups, constraints, penalty_coefficients)
